...
debug_image_file_path = os.path.join(resources_dir, 'Challenge_2_Test_Images', 'multiplePaths_test.png')
...
CAMERA_OFFSET = [-1, -44.7]  # Needs calibration. This is translation to move from pen centre to camera centre.
