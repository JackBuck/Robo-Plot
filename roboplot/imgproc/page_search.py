...
def compute_positions(width: int, height: int, photo_size: int, millimetres_between_photos: int = None):
    ...
    Args:
        ...
        height (int): The height of the paper (y axis).
        photo_size (int): The size of the square photo in mm.
        millimetres_between_photos (int): The distance in mm used to offset consecutive photos. If left as None, then
    ...
    if millimetres_between_photos is None:
        millimetres_between_photos = photo_size
    ...
    while not last_row:
        ...
        while current_path_point[1] < max_x_pos:
            ...
            current_path_point[1] += millimetres_between_photos
        ...
        if last_row:
            break
        elif current_path_point[0] + millimetres_between_photos > max_y_pos:
            current_path_point[0] = max_y_pos
            last_row = True
        else:
            current_path_point[0] += millimetres_between_photos
