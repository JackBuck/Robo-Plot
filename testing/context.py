...
_test_dir = os.path.dirname(os.path.realpath(os.path.join(os.getcwd(), os.path.expanduser(__file__))))
_roboplot_parentdir = os.path.normpath(os.path.join(_test_dir, '..'))
